...
public class AddVuforiaEnginePackage
{
    ...
    const string VUFORIA_TAR_FILE_DIR = "Assets/Resources/Third Party/Vuforia/Editor/Migration/";
    const string DEPENDENCIES_DIR = "Assets/Resources/Third Party/Vuforia/VuforiaDependencies";
