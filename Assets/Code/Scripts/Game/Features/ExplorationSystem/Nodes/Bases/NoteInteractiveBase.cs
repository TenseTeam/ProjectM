namespace ProjectM.Features.ExplorationSystem.Nodes
{
    ...
    public abstract class NodeInteractiveBase : NodeBase
    {
        ...
        {
            base.OnEnable();
            MainManager.Ins.EventManager.AddListener(GameEventKeys.OnChangedNode, Disable);
        ...
        {
            base.OnDisable();
            MainManager.Ins.EventManager.RemoveListener(GameEventKeys.OnChangedNode, Disable);
